...
if (($_SERVER['REQUEST_URI'] == '/collections/ego-accessories') &&
  ...
  (php_sapi_name() != "cli")) {
  header('HTTP/1.0 301 Moved Permanently');
  header('Location: /products/accessories');
  exit();
}
if (($_SERVER['REQUEST_URI'] == '/collections/ego-power-batteries-chargers') &&
  ...
  (php_sapi_name() != "cli")) {
  header('HTTP/1.0 301 Moved Permanently');
  header('Location: /products/batteries-chargers');
  exit();
}
if (($_SERVER['REQUEST_URI'] == '/collections/ego-power-chainsaw') &&
  ...
  (php_sapi_name() != "cli")) {
  header('HTTP/1.0 301 Moved Permanently');
  header('Location: /products/chainsaws');
  exit();
}
if (($_SERVER['REQUEST_URI'] == '/collections/ego-power-hedge-trimmer') &&
  ...
  (php_sapi_name() != "cli")) {
  header('HTTP/1.0 301 Moved Permanently');
  header('Location: /products/hedge-trimmers');
  exit();
}
if (($_SERVER['REQUEST_URI'] == '/collections/ego-power-leaf-blower') &&
  ...
  (php_sapi_name() != "cli")) {
  header('HTTP/1.0 301 Moved Permanently');
  header('Location: /products/leaf-blowers');
  exit();
}
if (($_SERVER['REQUEST_URI'] == '/collections/ego-power-line-trimmers') &&
  ...
  (php_sapi_name() != "cli")) {
  header('HTTP/1.0 301 Moved Permanently');
  header('Location: /products/line-trimmers-brush-cutters');
  exit();
}
if (($_SERVER['REQUEST_URI'] == '/collections/ego-power-mowers') &&
  ...
  (php_sapi_name() != "cli")) {
  header('HTTP/1.0 301 Moved Permanently');
  header('Location: /products/mowers');
  exit();
}
if (($_SERVER['REQUEST_URI'] == '/collections/ego-power-multi-tool-1') &&
  ...
  (php_sapi_name() != "cli")) {
  header('HTTP/1.0 301 Moved Permanently');
  header('Location: /products/multi-tool');
  exit();
}
